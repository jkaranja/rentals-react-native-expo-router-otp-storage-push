...
import { useSendContactMessageMutation } from "@/redux/contact/contactApiSlice";
...
const Contact = () => {
  ...
  return (
    <KeyboardAwareScrollView className="flex-1 p-4 pb-20">
      <Text className="text-lg font-semibold">Get in touch with us</Text>
      <Text className=" py-2">
