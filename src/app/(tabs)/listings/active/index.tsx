...
import { useDeleteDraftListingMutation } from "@/redux/listings/draft/draftApiSlice";
...
} from "@/redux/listings/active/activeApiSlice";
...
const ListingItem = ({ listing }: ListingProps) => {
  ...
  const [deactivateListing, { isLoading: isDeactivating }] =
    useDeactivateListingMutation();
    ...
    >
      ...
      <View className="flex-row justify-between">
        <IconButton
          ...
          size={12}
          onPress={() => deactivateListing(listing._id)}
        />
...
const ActiveListings = () => {
  ...
  const [activeTab, setActiveTab] = useState<string | JSX.Element>("Active");
