...
import { addToFilters } from "@/redux/listings/live/liveSlice";
...
const SearchBar = ({ handleOpen }: SearchBarProps) => {
  ...
  const placesLocationRef = useRef<GooglePlacesAutocompleteRef>(null);
  ...
  useEffect(() => {
    //placeRef.current?.setAddressText("Some Text");//set the value of TextInput
