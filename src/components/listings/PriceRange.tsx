    ...
    <View>
      ...
      <View className=" items-center">
        <MultiSlider
          ...
          selectedStyle={{
            backgroundColor: "rgb(25, 118, 210)", //Styles for selected range track
          }}
          unselectedStyle={{ backgroundColor: "rgba(25, 118, 210, 0.4)" }} //Styles for unselected track
          // pressedMarkerStyle={{}}
          markerStyle={{ backgroundColor: "rgb(25, 118, 210)" }} //Styles for markers
          // trackStyle={{ }}
        />
      </View>
    </View>
